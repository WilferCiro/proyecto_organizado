...
- Improve CSS support
- support image side-by-side or one-belowrequire_once(RELATIVE_PATH.'htmltoolkit.php');-another or both?
...
require_once('PDF3/fpdf.php');
require_once('PDF3/htmltoolkit.php');
...
//! @return An object (a class instance)
  ...
  $this->lineheight = 3.68; // Related to FontSizePt == 11
...
$dias=array("Mon"=>"Lunes","Tue"=>"Martes","Wed"=>"Mi&eacute;rcoles","Thu"=>"Jueves","Fri"=>"Viernes","Sat"=>"S&aacute;bado","Sun"=>"Domingo");
    $this->writeHTML('<hr />Fecha Impresi&oacute;n: '.$dias[date("D")]." ".date("d")." de ".$meses[date("M")]." de ".date("Y"));
    ...
    case 'ADDRESS': 
      ...
      switch($tag)
      {
		...
		case 'HR': //Default values: width=100% align=center color=gray
		  ...
		  $hralign = 'C';
		  $hrcolor = array('R'=>100,'G'=>100,'B'=>100);
